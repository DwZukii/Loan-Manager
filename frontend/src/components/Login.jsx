    ...
    <div className="min-h-screen flex font-sans text-slate-900 bg-slate-50">
      <div className="hidden md:flex md:w-1/2 bg-indigo-950 justify-center items-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-lg">
          <div className="mb-8 inline-flex items-center justify-center w-24 h-24 rounded bg-white/5 border border-white/10 shadow-xl backdrop-blur-sm">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-16 relative">
        <div className="w-full max-w-md">
          <div className="md:hidden text-center mb-10">
             <div className="mx-auto inline-flex items-center justify-center w-20 h-20 rounded bg-indigo-100 border border-indigo-200 mb-4 shadow-sm">
          ...
          <div className="bg-white rounded shadow-2xl shadow-indigo-950/5 p-8 sm:p-12 border border-slate-100 relative">
            ...
            {errorMsg && (
              <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded mb-6 text-sm font-semibold flex items-center gap-3">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full pl-11 p-4 bg-slate-50 border border-slate-200 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all text-sm font-medium" placeholder="you@company.com" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} className="w-full pl-11 pr-12 p-4 bg-slate-50 border border-slate-200 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all text-sm" placeholder="••••••••" />
