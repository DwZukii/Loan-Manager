...
export default function ManagerAgentProfile({ agent, userEmail, confirm, onBack }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8 relative">
      <div className="max-w-6xl mx-auto">
        <button onClick={onBack} className="mb-6 text-blue-600 font-bold hover:text-blue-800 flex items-center gap-2 transition">← Back to Dashboard</button>
                    ...
                    {currentProfileLeads.map((lead, index) => {
                      return (
                        <tr key={lead.id} className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="p-3 font-bold text-gray-800">{formatPhone(lead.phone_number)}</td>
